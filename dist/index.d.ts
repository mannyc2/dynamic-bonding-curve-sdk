import { Connection, PublicKey, Commitment, TransactionInstruction, Transaction, Keypair, GetProgramAccountsFilter } from '@solana/web3.js';
import { Program, IdlTypes, BN, IdlAccounts, Accounts, ProgramAccount } from '@coral-xyz/anchor';
import BN$1 from 'bn.js';
import Decimal from 'decimal.js';
import { ReadonlyUint8Array, Address, Rpc, SolanaRpcApi, Account, MaybeAccount, Instruction, TransactionSigner } from '@solana/kit';
...
declare class StateService extends DynamicBondingCurveProgram {
     ...
     */
    getPoolConfig(configAddress: PublicKey | string): Promise<PoolConfig$1>;
    /**
     * Get all config keys
     * @returns An array of config key accounts
     */
    getPoolConfigs(): Promise<ProgramAccount<PoolConfig$1>[]>;
    /**
     * Get all config keys of an owner wallet address
     * @param owner - The owner of the config keys
     * @returns An array of config key accounts
     */
    getPoolConfigsByOwner(owner: PublicKey | string): Promise<ProgramAccount<PoolConfig$1>[]>;
    /**
     * Get virtual pool data
     * @param poolAddress - The address of the pool
     * @returns A virtual pool or null if not found
     */
    getPool(poolAddress: PublicKey | string): Promise<VirtualPool$1>;
    /**
     * Get all dynamic bonding curve pools
     * @returns Array of pool accounts with their addresses
     */
    getPools(): Promise<ProgramAccount<VirtualPool$1>[]>;
    /**
     * Get all dynamic bonding curve pools by config key address
     * @param configAddress - The address of the config key
     * @returns Array of pool accounts with their addresses
     */
    getPoolsByConfig(configAddress: PublicKey | string): Promise<ProgramAccount<VirtualPool$1>[]>;
    /**
     * Get all dynamic bonding curve pools by creator address
     * @param creatorAddress - The address of the creator
     * @returns Array of pool accounts with their addresses
     */
    getPoolsByCreator(creatorAddress: PublicKey | string): Promise<ProgramAccount<VirtualPool$1>[]>;
    /**
     * Get pool by base mint
     * @param baseMint - The base mint address
     * @returns A virtual pool account
     */
    getPoolByBaseMint(baseMint: PublicKey | string): Promise<ProgramAccount<VirtualPool$1> | null>;
    /**
 ...
 */
declare function getQuoteReserveFromNextSqrtPrice(nextSqrtPrice: BN$1, config: PoolConfig$1): BN$1;
/**
 * Get the tokenomics
 * @param initialMarketCap - The initial market cap
 * @param migrationMarketCap - The migration market cap
 ...
 */
declare function validateBaseTokenType(baseTokenType: TokenType, poolConfig: PoolConfig$1): boolean;
/**
...
type DynamicBondingCurveLegacyTransactionClient = Pick<DynamicBondingCurveClient, 'pool' | 'partner' | 'creator' | 'migration'>;
declare class DynamicBondingCurveKitClient {
    ...
    private constructor();
    static fromLegacyClient(legacyClient: DynamicBondingCurveLegacyTransactionClient, rpcUrl: string): DynamicBondingCurveKitClient;
    static fromRpcUrl(rpcUrl: string, commitment?: Commitment): DynamicBondingCurveKitClient;
}
 ...
 */
declare function getTotalFeeNumeratorFromIncludedFeeAmount(poolFees: PoolFeesConfig$1, volatilityTracker: VolatilityTracker$1, currentPoint: BN$1, activationPoint: BN$1, includedFeeAmount: BN$1, tradeDirection: TradeDirection): BN$1;
/**
 ...
 * @returns Total fee numerator
 */
declare function getTotalFeeNumeratorFromExcludedFeeAmount(poolFees: PoolFeesConfig$1, volatilityTracker: VolatilityTracker$1, currentPoint: BN$1, activationPoint: BN$1, excludedFeeAmount: BN$1, tradeDirection: TradeDirection): BN$1;
/**
 ...
 * @returns Total fee numerator
 */
declare function getTotalFeeNumerator(baseFeeNumerator: BN$1, dynamicFee: DynamicFeeConfig$1, volatilityTracker: VolatilityTracker$1): BN$1;
/**
 ...
 */
declare function getFeeOnAmount(tradeFeeNumerator: BN$1, amount: BN$1, poolFees: PoolFeesConfig$1, hasReferral: boolean): FeeOnAmountResult;
/**
 ...
 */
declare function splitFees(poolFees: PoolFeesConfig$1, feeAmount: BN$1, hasReferral: boolean): [BN$1, BN$1, BN$1];
 ...
 * @returns Swap result
 */
declare function getSwapResult(poolState: VirtualPool$1, configState: PoolConfig$1, amountIn: BN$1, feeMode: FeeMode, tradeDirection: TradeDirection, currentPoint: BN$1, eligibleForFirstSwapWithMinFee: boolean): SwapResult;
/**
 ...
 */
declare function swapQuote(virtualPool: VirtualPool$1, config: PoolConfig$1, swapBaseForQuote: boolean, amountIn: BN$1, slippageBps: number, hasReferral: boolean, currentPoint: BN$1, eligibleForFirstSwapWithMinFee: boolean): SwapQuoteResult;
/**
 ...
 * @returns Swap result
 */
declare function getSwapResultFromExactInput(virtualPool: VirtualPool$1, config: PoolConfig$1, amountIn: BN$1, feeMode: FeeMode, tradeDirection: TradeDirection, currentPoint: BN$1, eligibleForFirstSwapWithMinFee: boolean): SwapResult2;
/**
 ...
 * @returns Swap result
 */
declare function getSwapResultFromPartialInput(virtualPool: VirtualPool$1, config: PoolConfig$1, amountIn: BN$1, feeMode: FeeMode, tradeDirection: TradeDirection, currentPoint: BN$1, eligibleForFirstSwapWithMinFee: boolean): SwapResult2;
/**
 ...
 * @returns Swap result
 */
declare function getSwapResultFromExactOutput(virtualPool: VirtualPool$1, config: PoolConfig$1, amountOut: BN$1, feeMode: FeeMode, tradeDirection: TradeDirection, currentPoint: BN$1, eligibleForFirstSwapWithMinFee: boolean): SwapResult2;
/**
 ...
 */
declare function calculateBaseToQuoteFromAmountOut(configState: PoolConfig$1, currentSqrtPrice: BN$1, outAmount: BN$1): SwapAmount;
/**
 ...
 * @returns Swap amount with input calculated
 */
declare function calculateQuoteToBaseFromAmountOut(configState: PoolConfig$1, currentSqrtPrice: BN$1, outAmount: BN$1): SwapAmount;
/**
 ...
 * @returns Swap quote result
 */
declare function swapQuoteExactIn(virtualPool: VirtualPool$1, config: PoolConfig$1, swapBaseForQuote: boolean, amountIn: BN$1, slippageBps: number, hasReferral: boolean, currentPoint: BN$1, eligibleForFirstSwapWithMinFee: boolean): SwapQuote2Result;
/**
 ...
 * @returns Swap quote result
 */
declare function swapQuotePartialFill(virtualPool: VirtualPool$1, config: PoolConfig$1, swapBaseForQuote: boolean, amountIn: BN$1, slippageBps: number, hasReferral: boolean, currentPoint: BN$1, eligibleForFirstSwapWithMinFee: boolean): SwapQuote2Result;
/**
 ...
 */
declare function swapQuoteExactOut(virtualPool: VirtualPool$1, config: PoolConfig$1, swapBaseForQuote: boolean, outAmount: BN$1, slippageBps: number, hasReferral: boolean, currentPoint: BN$1, eligibleForFirstSwapWithMinFee: boolean): SwapQuote2Result;
 ...
 */
declare function isDynamicFeeEnabled(dynamicFee: DynamicFeeConfig$1): boolean;
/**
 ...
 */
declare function getVariableFeeNumerator(dynamicFee: DynamicFeeConfig$1, volatilityTracker: VolatilityTracker$1): BN$1;
